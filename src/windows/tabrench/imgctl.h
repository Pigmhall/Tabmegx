/*
 ************************************************
 *	imgctl.h version 1.27
 *		For imgctl.dll version 1.27.
 ************************************************
 */
/*
 *	[著作権について]
 ...
 *
 *	[PNGについて]
 *		imgctl のPNG読み書き処理には libpng 1.4.1 と zlib 1.2.3 が利用されています。
...
#define IMGCTL_VERSION			127
#define IMGCTL_BETA				0
#define IMGCTL_VERSION_STRING	"1.27"
